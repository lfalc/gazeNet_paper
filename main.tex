...
\begin{figure}[h]
    ...
    \caption{The two graphs on the left show the x and y coordinates of the gaze position over time. The graph on the right resembles the gaze position in the x-y-plane. The red dots represent fixations, the blue dots represent saccades and the green dots represent post saccadic oscillations.}
\end{figure}
